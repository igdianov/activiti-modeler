...
Plugins allow you to change the appearance and behavior of the Activiti Modeler and add new features.

![Activiti Modeler Plugins](./screencast.gif)
<p align="center">Using the Activiti Modeler with a Plugin</p>

## Plugging into the Activiti Modeler
...
Finally, put the folder into the `resources/plugins` directory relative to your Activiti Modeler installation directory. You can now use your plugin!
