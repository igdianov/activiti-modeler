...
const expectedFiles = {
  win: [
    {
      name: 'activiti-modeler-${version}-win-${arch}.zip',
      archs,
      contents: [
        'Activiti Modeler.exe',
        'support/register_fileassoc.bat',
        'LICENSE.activiti-modeler.txt',
        'THIRD_PARTY_NOTICES.activiti-modeler.txt',
        'VERSION'
      ]
    }
  ],
  ...
  mac: [
    'activiti-modeler-${version}-mac.dmg',
    {
      name: 'activiti-modeler-${version}-mac.zip',
      archs: [ 'x64' ],
      contents: [
        'Activiti Modeler.app/Contents/Info.plist'
      ]
    }
  ]
};
