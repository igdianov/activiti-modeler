...
<head>
<meta charset="utf-8">
<title>Activiti Modeler ${currentVersion} Third Party Notices Changes Summary</title>
<style>${style}</style>
</head>
<body>
  <h1>
    Activiti Modeler Third Party Notices Changes
  </h1>
${diffHtml}
</body>
</html>
...
function getDraftEmail(summary, currentVersion, changesSummary) {
  const subject = `Activiti Modeler ${currentVersion} Third Party Summary`;
